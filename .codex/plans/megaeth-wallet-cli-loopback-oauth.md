...
- [ ] task-2: Implement config, profiles, and redaction
- [ ] task-3: Implement loopback login
- [ ] task-4: Implement wallet status commands

### Epic 3: Wallet Primitives

- [ ] task-5: Implement read-only call
- [ ] task-6: Implement execute through relay
- [ ] task-7: Implement transfer wrapper

### Epic 4: Documentation

- [ ] task-8: Document CLI and agent usage
